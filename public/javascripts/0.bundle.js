...
var _shorts = __webpack_require__(833);
...
var _buttons = __webpack_require__(853);

var _container = __webpack_require__(855);

var _dropdown = __webpack_require__(857);

var _forms = __webpack_require__(859);

var _LastAdded = __webpack_require__(861);

var _LastAdded2 = _interopRequireDefault(_LastAdded);
...
console.log('buttons', _buttons.btn, _container.container);
...
var Index = function (_React$Component) {
  ...
  function Index(props) {
    ...
    _this.goToCreatePage = _this.goToCreatePage.bind(_this);
  ...
  _createClass(Index, [{
    ...
    key: 'goToCreatePage',
    value: function goToCreatePage(name) {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: _forms.inputGroup },
            React.createElement('input', { id: 'hhh', className: _forms.formControl }),
            React.createElement(
              'span',
              { className: _forms.inputGroupAddon },
              '@example.com'
            )
          )
        ),
        React.createElement(
          'div',
          { className: _forms.inputGroup },
          React.createElement('input', { type: 'text', className: _forms.formControl }),
          React.createElement(
            'div',
            { className: _forms.inputGroupBtn + ' ' + _dropdown.show },
            React.createElement(
              'button',
              { type: 'button', className: _buttons.btnSecondary + ' ' + _buttons.btn + ' ' + _buttons.btnLg + ' ' + _dropdown.dropdownToggle },
              'Action'
            ),
            React.createElement(
              'div',
              { className: _dropdown.dropdownMenu + ' ' + _dropdown.dropdownMenuRight + ' ' + _dropdown.show },
              React.createElement(
                'a',
                { className: _dropdown.dropdownItem, href: '/' },
                'Action'
              ),
              React.createElement(
                'a',
        ...
        React.createElement(
          'button',
          { className: _buttons.btnPrimary + ' ' + _buttons.btn + ' ' + _buttons.btnLg },
          'tttt'
        ),
        React.createElement(_LastAdded2.default, {
...
exports.default = (0, _reactRedux.connect)(function (state, ownProps) {
  ...
  return {
    onGetLastShorts: function onGetLastShorts() {
      dispatch((0, _shorts.getLastShorts)());
    }
  };
})(Index);
...
Index.propTypes = {
  onGetLastShorts: _propTypes2.default.func.isRequired,
  lastShorts: _propTypes2.default.shape({
...
var isBuffer = __webpack_require__(836);
...
var normalizeHeaderName = __webpack_require__(838);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __webpack_require__(714);
...
var utils = __webpack_require__(707);
var settle = __webpack_require__(839);
var buildURL = __webpack_require__(841);
var parseHeaders = __webpack_require__(842);
var isURLSameOrigin = __webpack_require__(843);
var createError = __webpack_require__(715);
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(844);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(845);
...
var enhanceError = __webpack_require__(840);
...
var getLastShorts = exports.getLastShorts = function getLastShorts() {
  return function (dispatch) {
    dispatch({
      type: 'FETCH_LASTSHORTS_ONLOAD'
    });

    axios.get('/api/shorts').then(function (response) {
...
var getShorts = exports.getShorts = function getShorts() {
  return function () {};
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(834)))
...
var utils = __webpack_require__(707);
var bind = __webpack_require__(713);
var Axios = __webpack_require__(837);
var defaults = __webpack_require__(708);
...
axios.Cancel = __webpack_require__(717);
axios.CancelToken = __webpack_require__(851);
axios.isCancel = __webpack_require__(716);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __webpack_require__(852);
...
var isCancel = __webpack_require__(716);
var defaults = __webpack_require__(708);
...
var Cancel = __webpack_require__(717);
...
var _addCircle = __webpack_require__(862);

var _addCircle2 = _interopRequireDefault(_addCircle);

var _colors = __webpack_require__(54);

var _Item = __webpack_require__(863);

var _Item2 = _interopRequireDefault(_Item);

var _styles = __webpack_require__(870);
...
var LastAdded = function LastAdded(_ref) {
  var title = _ref.title,
      content = _ref.content,
      goToCreatePage = _ref.goToCreatePage,
      name = _ref.name,
      showMoreDetails = _ref.showMoreDetails;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: _styles2.default.titleBlock },
          React.createElement(_Title2.default, { title: title, type: 'h2', marginBottom: false }),
          React.createElement(_addCircle2.default, {
            style: iconStyles,
            color: _colors.lime600,
            hoverColor: _colors.lime800,
            onClick: function onClick() {
              return goToCreatePage(name);
            }
          })
        ),
...
LastAdded.propTypes = {
  ...
  goToCreatePage: _propTypes2.default.func.isRequired,
  name: _propTypes2.default.string.isRequired,
  showMoreDetails: _propTypes2.default.func.isRequired
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var _checkCircle = __webpack_require__(292);

var _checkCircle2 = _interopRequireDefault(_checkCircle);

var _visibility = __webpack_require__(864);

var _visibility2 = _interopRequireDefault(_visibility);

var _favorite = __webpack_require__(865);

var _favorite2 = _interopRequireDefault(_favorite);

var _Card = __webpack_require__(291);

var _moment = __webpack_require__(866);

var _moment2 = _interopRequireDefault(_moment);

var _styles = __webpack_require__(868);
...
var backgroundImage = function backgroundImage(cover) {
  return {
    backgroundImage: cover ? 'url(' + cover.upload_path + ')' : 'url(http://gamelayer.ru/gameimg/igry-vremja-prikljuchenij-1.jpg)'
  };
};
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        _Card.Card,
        { onClick: function onClick() {
            showMoreDetails(content.id);
          } },
        React.createElement(
          _Card.CardHeader,
          { style: { textAlign: 'right' } },
          React.createElement(_checkCircle2.default, null),
          React.createElement(_visibility2.default, null),
          React.createElement(_favorite2.default, null)
        ),
        React.createElement(
          _Card.CardMedia,
          {
            overlay: React.createElement(_Card.CardTitle, {
              title: content.title,
              subtitle: content.original_title + ' (' + (0, _moment2.default)(content.release_date, 'YYYY') + ' \u0433.)'
            })
          },
...
var _moment = __webpack_require__(706);
...
exports.default = function (date, format) {
  return (0, _moment2.default)(Number(new Date(date))).format(format);
};
...
// module
exports.push([module.i, ".titleBlock {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 20px\n}\n", ""]);
